...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rosie
```

A live public deployment of this template is available at [https://rosie.templates.workers.dev](https://rosie.templates.workers.dev)
